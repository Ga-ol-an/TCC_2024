...
h1 iperf -c 10.0.0.4 -p 5001 -u -b 10M -t 15 -e & ## h1 5 seg 
px time.sleep(5)
h2 iperf -c 10.0.0.4 -p 5002 -u -b 10M -t 35 -e & ## h1 h2 5 seg
px time.sleep(15)                                 ## h2 5 seg
h3 iperf -c 10.0.0.4 -p 5003 -u -b 10M -t 35 -e & ## h2 h3 10 seg
px time.sleep(10)
