...
h4 iperf -s -u -i 1 -p 5001 -e > outputs/variant/h4_server_h1 & 
h4 iperf -s -u -i 1 -p 5002 -e > outputs/variant/h4_server_h2 & 
h4 iperf -s -u -i 1 -p 5003 -e > outputs/variant/h4_server_h3 & 
px time.sleep(1)
