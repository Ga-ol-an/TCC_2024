...
## Add the queues
curl -X POST -d '{"port_name": "s1-eth4", "type": "linux-htb","max_rate": "10000000", "queues":[{"max_rate": "8000000", "min_rate": "3000000" },{"max_rate": "4000000","min_rate": "2000000"},{"max_rate": "5000000","min_rate": "3000000"}]}' http://localhost:8080/qos/queue/0000000000000001
sleep .5 # Waits 0.5 second.
##A Add the QoS
