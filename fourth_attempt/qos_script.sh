...
echo 
sleep .5 # Waits 0.5 second.
curl -X POST -d '{"priority": "2","match": { "tp_dst": "5002" ,"nw_proto": "UDP", "dl_type":"IPv4"}, "actions": {"queue": "1"}}' http://localhost:8080/qos/rules/0000000000000001 
echo 
sleep .5 # Waits 0.5 second.
curl -X POST -d '{"priority": "3","match": { "tp_dst": "5003" ,"nw_proto": "UDP", "dl_type":"IPv4"}, "actions": {"queue": "2"}}' http://localhost:8080/qos/rules/0000000000000001 
echo